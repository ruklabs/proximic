...
export default function Voice() {
  ...
  const call = async () => {
    ...
    pc.onicecandidate = event => {
      ...
      event.candidate && pushToList(offerCandidatesPath, event.candidate.toJSON());
    };
  ...
  const answer = async () => {
    ...
    pc.onicecandidate = event => {
      ...
      event.candidate && pushToList(answerCandidatesPath, event.candidate.toJSON());
    };
  ...
  return (
    <main>
      ...
      <button type="button" onClick={enableAudio}>Enable</button>
